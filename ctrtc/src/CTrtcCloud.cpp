...
void sendTrtcCustomVideoData(CTrtcCloud obj,CTRTCVideoStreamType streamType,int width,int height,char* i420Buffer,int length,uint64_t timestamp,CTRTCVideoRotation rotation){
    auto *cloud=static_cast<ITRTCCloud *>(obj);
